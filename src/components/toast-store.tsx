'use client';
import { Aria, ToastPosition, ToastType } from './types';
...
export interface Toast {
    ...
    promise?: Promise<void>; // For promise support
...
export const onExpandToast = (id: string) => {
    //finding the details of toast with the id
    const toast = toastList.find((t) => t.id === id);
    //if onDismiss callback is sent then return callback with toast data
