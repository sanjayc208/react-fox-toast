...
export const defaultIcons: any = {
    ...
    envelope: (<svg width="25" height="25" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" version="1.1">
      <g style={{"stroke":"#333333","strokeWidth":"2"}}>
        <path style={{"fill":"#ffc247"}} d="m 3,16 94,0 0,68 -94,0 z"/>
        <path style={{"fill":"#ffe45c"}} d="m 4,16 34,33 c 7,7 15,7 23,0 L 96,16 z"/>
