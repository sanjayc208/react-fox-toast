...
export default function Home() {
    ...
    const [onScreenRef, onScreenVisible] = useOnScreen() as [
    ...
    return (
        <div className="">
            <div
                className={`relative ${isMobile ? 'min-h-[77vh]' : ''} flex w-full flex-col items-center justify-center overflow-hidden`}
            >
                <header></header>
                <Meteors number={40} />
                ...
                >
                    ...
                    {!isMobile && (
                        <div
                            className={`xs:text-sm xs:my-2 xs:m-3 md:my-16 md:text-md text-yellow-950 font-semibold`}
                        >
                            <TextAnimate
                                delay={1000}
                                animation="scaleUp"
                            ...
                            >
                                ...
                                Like a Fox, which thrives in the quiet spaces
                                between the trees
                            </TextAnimate>
                            <TextAnimate
                                delay={10000}
                                ...
                                as="h1"
                            >
                                this library is a silent but powerful
                                presence—quick to act, yet never overwhelming.
                            </TextAnimate>
                            <TextAnimate
                                delay={10000}
                                animation="scaleUp"
                                as="h1"
                            >
                                It moves with purpose, light as a shadow, and as
                                adaptable as the fox itself.
                            </TextAnimate>
                        </div>
                    )}
                </motion.div>
            ...
            <div className="grid grid-cols-2 xs:gap-2 sm:gap-5 items-center">
                ...
                <button
                    onClick={() =>
                        toast(<>Welcome to React Fox Toast!</>, {
                            position: 'top-center',
                            icon: (
            ...
            <div className="z-10 grid grid-cols-1 gap-2 min-h-20 items-center justify-center">
                <div
                    ...
                    onClick={() =>
                        window.open(
                            'https://github.com/sanjayc208/react-fox-toast',
                            '_blank'
                        )
                    }
                >
          ...
          <button onClick={() => window.open("https://www.buymeacoffee.com/sanjayc208", "_blank")}>
            ...
            <div
                ref={onScreenRef || undefined}
                className="mx-auto xs:px-4 lg:px-20 md:lg:px-12 sm:lg:px-12 py-5 lg:min-h-[630px]"
            >
                {onScreenVisible && (
                    <TypingAnimation
                ...
                <div className="flex flex-col lg:flex-row gap-4 items-center">
                    <div className="xs:w-[22rem] xs:max-w-[22rem] lg:max-w-[400px] lg:min-w-[400px] p-3">
                        ...
                        <p className="text-xl text-muted-foreground">
                            Lightweight. Flexible. Powerful. Everything you
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                <ul className="list-disc pl-5 space-y-2">
                                    <li>
                                        Fully customizable: position, duration,
                                        content.
                                    </li>
                                    <li>
                                        Supports promises for dynamic messages.
                                    </li>
                                    <li>Expandable toasts for more content.</li>
                                    <li>
                                        Global container for easy management.
                                    </li>
                                    <li>
                                        TailwindCSS-ready for quick styling.
                                    </li>
                                    <li>Pause on hover to control timing.</li>
                                    <li>
                                        Ultra-lightweight with no performance
                                        hit.
                                    </li>
                                </ul>
                            </CardContent>
            ...
            <footer className="w-full mt-8 bg-[#e0e0d6] text-gray-800 border-t border-gray-300">
                <div className="flex items-center justify-center p-4">
                    <p className="text-sm text-center">
                        © {new Date().getFullYear()} <b>react-fox-toast</b> by{' '}
                        <b>Sanjay Rajeev</b>. All rights reserved.
                    </p>
                </div>
            </footer>
        </div>
