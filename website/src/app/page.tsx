          ...
          {!isMobile && (
            ...
            >
              ...
              <TextAnimate delay={10000} animation="scaleUp" as="h1">
                this library is a silent but powerful presence—quick to act, yet
                never overwhelming.
              </TextAnimate>
              <TextAnimate delay={10000} animation="scaleUp" as="h1">
                It moves with purpose, light as a shadow, and as adaptable as
                the fox itself.
              </TextAnimate>
            </div>
          )}
        ...
        >
          ...
          <span className="grid grid-cols-5 py-1 xs:gap-1 sm:gap-2 relative text-black transition duration-300 group-hover:text-yellow-800 ease items-center justify-center">
            ...
            <span className="col-span-4">
              {isMobile ? 'Try it Yourself' : 'Try it out Yourself'}
            </span>
          </span>
        </button>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-4 items-center">
          <div className="xs:w-[22rem] xs:max-w-[22rem] lg:max-w-[400px] lg:min-w-[400px] p-3">
            ...
            <p className="text-xl text-muted-foreground">
              Lightweight. Flexible. Powerful. Everything you need, nothing you
              don't.
            </p>
            <Card>
              <CardHeader>
