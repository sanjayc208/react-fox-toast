    ...
    <div className="space-y-6 xs:max-w-[95vw] md:max-w-full">
      ...
      <Card>
        ...
        <CardContent id="example-drawer" className="space-y-4">
          ...
          <h3 className="font-semibold text-lg text-gray-800">Example of Toast Drawer</h3>
          <p className="text-gray-700">
    ...
    expandedContent: (
      <div className="p-4 bg-white lg max-w-md">
        ...
        <div className="space-y-4 border-t pt-4">
          ...
          <h3 className="font-semibold text-lg text-gray-800">Why Use Toast Drawer?</h3>
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            <li><strong>Progressive Disclosure:</strong> Show essential info first, reveal details on demand</li>
            <li><strong>Interactive Content:</strong> Supports forms, media, and complex components in expanded state</li>
            <li><strong>Space Efficient:</strong> Maintains clean UI while offering access to detailed content</li>
            <li><strong>Context Preservation:</strong> Keeps users in flow by showing additional content in-place</li>
            <li><strong>Use Cases:</strong> Message threads, detailed notifications, quick forms, multi-step actions</li>
          </ul>
        </CardContent>
      </Card>
    </div>
