    ...
    return (
        <div className="space-y-6 xs:max-w-[95vw] md:max-w-full">
            ...
            <p className="text-lg text-muted-foreground mb-6">
                The **Toast Drawer** introduces an expandable/collapsible
                container perfect for showing detailed content while maintaining
                a clean interface. Users can click to expand and view additional
                information, forms, or messages without leaving the context.
            </p>
            ...
            <Card>
                <CardHeader>
                    <CardTitle id="what-is-drawer">
                        What is Toast Drawer?
                    </CardTitle>
                    <CardDescription>
                        A collapsible container that expands on click, ideal for
                        progressive disclosure of content while maintaining a
                        minimal initial footprint. Perfect for detailed
                        messages, forms, or supplementary information.
                    </CardDescription>
                </CardHeader>
                <CardContent id="example-drawer" className="space-y-4">
                    <p className="text-gray-700">
                        The Drawer Toast maintains all regular toast behaviors
                        while adding toggleable content sections. Its
                        collapsible nature makes it excellent for scenarios
                        where you want to provide optional additional
                        information without cluttering the UI.
                    </p>
          ...
          <p className="text-gray-600">
            This expanded drawer is perfect for showing detailed content...
                    ...
                    <ul className="list-disc list-inside text-gray-700 space-y-2">
                        <li>
                            <strong>Progressive Disclosure:</strong> Show
                            essential info first, reveal details on demand
                        </li>
                        <li>
                            <strong>Interactive Content:</strong> Supports
                            forms, media, and complex components in expanded
                            state
                        </li>
                        <li>
                            <strong>Space Efficient:</strong> Maintains clean UI
                            while offering access to detailed content
                        </li>
                        <li>
                            <strong>Context Preservation:</strong> Keeps users
                            in flow by showing additional content in-place
                        </li>
                        <li>
                            <strong>Use Cases:</strong> Message threads,
                            detailed notifications, quick forms, multi-step
                            actions
                        </li>
                    </ul>
                </CardContent>
