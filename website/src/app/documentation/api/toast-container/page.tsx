    ...
    return (
        <div className="xs:max-w-[95vw] md:max-w-full">
            ...
            <p className="text-lg text-muted-foreground">
                The ToastContainer component is used to create a global
                container for toasts in your React application.
            </p>
                ...
                <TabsContent value="usage">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                How to use the ToastContainer component in your
                                app
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
  ...
  return (
    <div>
      ...
      {/* Your app content */}
                            ...
                            />
                            <p className="mt-4">
                                Add the ToastContainer component to your root
                                component or layout to enable toast
                                notifications throughout your application.
                            </p>
                        </CardContent>
                    </Card>
                                ...
                                <TableBody>
                                    <TableRow>
                                        ...
                                        <TableCell>
                                            ...
                                            custom styles and classes for
                                            different toast types (e.g.,
                                            success, error, etc.).
                                        </TableCell>
                                        <TableCell>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell>
                                            Defines the default position of the
                                            toast container (e.g., 'top-left',
                                            'bottom-right').
                                        </TableCell>
                                        <TableCell>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell>
                                            Defines the text direction inside
                                            the ToastContainer. You can set it
                                            to either 'ltr' (left-to-right) or
                                            'rtl' (right-to-left).
                                        </TableCell>
                                        <TableCell>
                                            <code>{`'ltr' | 'rtl'`}</code>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell>
                                            Defines the pause of the toast
                                            container when a user hovers over a
                                            toast notification.
                                        </TableCell>
                                        <TableCell>
                                            <code>{`boolean`}</code>
