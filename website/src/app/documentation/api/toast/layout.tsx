...
export default function ToastAPILayout({
  ...
  React.useEffect(() => {
    ...
    if (
      ['usage', 'types', 'customization', 'management'].includes(tabFromUrl)
    ) {
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-lg text-muted-foreground">
        The toast() API is used for creating various types of toast
        notifications in your React application.
      </p>
