  ...
  return (
    <div className="space-y-6 xs:max-w-[95vw] md:max-w-full">
      ...
      <p className="text-lg text-muted-foreground">
        Learn how to customize the look and feel of your application using our
        theming system.
      </p>
      ...
      <Card id="global-theming">
        ...
        <CardContent className="space-y-4">
          <p className="text-md">
            Global theming allows you to customize the default appearance of
            each toast type. Here's an example of how you can pass the{' '}
            <code>`toastTypeTheming`</code> prop to customize your toasts.
          </p>
...
/>`,
          ...
          />
          <p className="mt-4">
            Use the `toastTypeTheming` prop to apply global styles and classes
            to different types of toasts. This allows for consistent styling
            across your application while still allowing for customization of
            individual toasts.
          </p>
        </CardContent>
      </Card>
