      ...
      <div id="installation-step-2" className="flex lg:gap-x-3 xs:gap-x-1">
        ...
        <div className="flex flex-col lg:flex-row gap-4 pt-0.5 pb-8 w-full">
          <div className="xs:w-full md:w-[70%]">
            ...
            <p>
              Adding ToastContainer on the Component where 'toast' hook will be
              used also works
            </p>
          </div>
          <div className="xs:max-w-[85vw] md:w-full md:max-w-full overflow-x-auto">
      ...
      <div id="installation-step-3" className="flex lg:gap-x-3 xs:gap-x-1">
        ...
        <div className="flex flex-col lg:flex-row gap-4 pt-0.5 pb-8">
          <div className="xs:w-full md:w-[70%]">
            ...
            <p>
              Use this in any JSX/TSX component and if using NEXT.JS then see to
              it that there is 'use client'; on top . Since react-fox-toast
              supports only client side
            </p>
          </div>
          <div className="xs:max-w-[85vw] md:w-full md:max-w-full overflow-x-auto">
            <CustomSyntaxHighlighter
