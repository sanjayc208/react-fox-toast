        ...
        <div className="max-w-fit my-4">
            <div className="flex lg:lg:gap-x-3 xs:gap-x-1">
                <div
                    ...
                    className="relative last:after:hidden after:absolute after:top-7 after:bottom-0 after:start-3.5 after:w-px after:-translate-x-[0.5px] after:bg-gray-300 dark:after:bg-neutral-700"
                >
                    <div className="relative z-10 size-7 flex justify-center items-center">
                        <div className="flex justify-center items-center size-5 rounded-full bg-gray-400 dark:bg-neutral-600">
                            <span className="text-defaultBase text-lg font-semibold">
                                1
                            </span>
                        </div>
                    </div>
                ...
                <div className="flex flex-col lg:flex-row gap-4 pt-0.5 pb-8 w-full">
                    ...
                    <div className="xs:max-w-[85vw] md:w-full md:max-w-full overflow-x-auto">
                        <CustomSyntaxHighlighter
                            className="border rounded-lg overflow-x-auto shadow-lg"
                            tabs={{
                                npm: {
            ...
            <div
                ...
                className="flex lg:gap-x-3 xs:gap-x-1"
            >
                ...
                <div className="flex flex-col lg:flex-row gap-4 pt-0.5 pb-8 w-full">
                    <div className="xs:w-full md:w-[70%]">
                        ...
                        <p>
                            Adding ToastContainer on the Component where 'toast'
                            hook will be used also works
                        </p>
                    </div>
                    <div className="xs:max-w-[85vw] md:w-full md:max-w-full overflow-x-auto">
                        <CustomSyntaxHighlighter
            ...
            >
                ...
                <div className="flex flex-col lg:flex-row gap-4 pt-0.5 pb-8">
                    <div className="xs:w-full md:w-[70%]">
                        ...
                        <p>
                            Use this in any JSX/TSX component and if using
                            NEXT.JS then see to it that there is 'use client';
                            on top . Since react-fox-toast supports only client
                            side
                        </p>
                    </div>
                    <div className="xs:max-w-[85vw] md:w-full md:max-w-full overflow-x-auto">
